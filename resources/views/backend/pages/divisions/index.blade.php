          ...
          <table class="table table-hover table-striped">
            ...
            @foreach ($divisions as $division)
              <tr>
                ...
                <td>
                  <a href="{{ route('admin.division.edit', $division->id) }}" class="btn btn-success">تعديل</a>

                  <a href="#deleteModal{{ $division->id }}" data-toggle="modal" class="btn btn-danger">حذف</a>
