    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="general-pages">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ route('admin.products') }}">ادارة الاصناف</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('admin.product.create') }}">اضافة صنف
                            جديدة</a></li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="category-pages">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ route('admin.categories') }}">ادارة التصنيفات</a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('admin.category.create') }}">اضافة تصنيف
                            جديد</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            ...
            <div class="collapse" id="brand-pages">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ route('admin.brands') }}">ادارة العلامات
                            التجارية</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('admin.brand.create') }}">اضافة علامة
                            تجارية</a></li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="slider-pages">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ route('admin.sliders') }}">ادرة عارض
                            الصور</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#email-pages" aria-expanded="false"
                aria-controls="general-pages"> <span class="menu-title">
                    ادارة الرسائل</span><i class="menu-arrow"></i></a>
            <div class="collapse" id="email-pages">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ route('message.create') }}">ارسال</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('message.show') }}">عرض
                        </a></li>
